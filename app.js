...
class App extends React.Component {
  constructor(props){
    ...
    this.state={
      ...
      stateservice:false,
      stateportfolio: true,
        stateStroitelstvo: false,
        stateStrahovanie: false,
        stateButy:false,
        stateZdorovie:false,
        crm: false,
    ...
    this.ComponentShowInPortfolioStroitelstvo = this.ComponentShowInPortfolioStroitelstvo.bind(this);
    this.ComponentShowInPortfolioStrahovanie = this.ComponentShowInPortfolioStrahovanie.bind(this);
    this.ComponentShowInPortfolioButy = this.ComponentShowInPortfolioButy.bind(this);
    this.ComponentShowInPortfolioZdorovie = this.ComponentShowInPortfolioZdorovie.bind(this);
    this.ComponentShowInPortfolioManagment = this.ComponentShowInPortfolioManagment.bind(this);
  }
    ...
    return (
      <div>
        ...
        <main>
          ...
          ComponentShowInPortfolioStroitelstvo = {this.ComponentShowInPortfolioStroitelstvo}
          ComponentShowInPortfolioStrahovanie = {this.ComponentShowInPortfolioStrahovanie}
          ComponentShowInPortfolioButy = {this.ComponentShowInPortfolioButy}
          ComponentShowInPortfolioZdorovie = {this.ComponentShowInPortfolioZdorovie}
          ComponentShowInPortfolioManagment = {this.ComponentShowInPortfolioManagment}
          />
        </main>
